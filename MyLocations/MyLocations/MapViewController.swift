        ...
        didSet {
            NotificationCenter.default.addObserver(forName:
                Notification.Name.NSManagedObjectContextObjectsDidChange,
                                                   ...
                                                   queue: OperationQueue.main) { notification in // or can be written as _ in
                                                    if self.isViewLoaded {
                                                        self.updateLocations() //try to make the reloading of the locations more efficient by not re-fetching the entire list of Location objects, but by only inserting or deleting those that have changed.
                                                    }
            }
        }
    }
